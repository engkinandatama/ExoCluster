...
def main():
    ...
    parser.add_argument("--num-genomes", type=int, default=10, help="Number of mock genomes to generate")
    ...
    mmseqs2_time = run_pipeline(genomes_mock, annotations_mock, mmseqs2_output, "mmseqs2")
    
    # Print results
    print("\nBenchmark Results:")
    print("------------------")
    print(f"Number of genomes: {args.num_genomes}")
    print(f"kmer method time: {kmer_time:.2f} seconds" if kmer_time else "kmer method failed")
    print(f"mmseqs2 method time: {mmseqs2_time:.2f} seconds" if mmseqs2_time else "mmseqs2 method failed")
